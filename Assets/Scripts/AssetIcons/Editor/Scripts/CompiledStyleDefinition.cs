...
{
	/// <summary>
	/// <para>A formatted representation of the <see cref="StyleDefinition"/> for drawing graphics in the <see cref="AssetIconDrawer"/>.</para>
	/// </summary>
	/// <seealso cref="StyleDefinition"/>
	/// <seealso cref="AssetIconDrawer"/>
	public sealed class CompiledStyleDefinition
	{
		/// <summary>
		/// <para>A <see cref="CompiledStyleDefinition"/> for the default constructor of <see cref="StyleDefinition"/>.</para>
		/// </summary>
		/// <seealso cref="StyleDefinition"/>
		public static readonly CompiledStyleDefinition Default = new CompiledStyleDefinition(new StyleDefinition());
		...
		/// <summary>
		/// <para>Constructs a new instance of the <see cref="CompiledStyleDefinition"/> from a <see cref="StyleDefinition"/>.</para>
		/// </summary>
		public CompiledStyleDefinition(StyleDefinition style)
		{
		...
		/// <summary>
		/// <para>Applies this <see cref="CompiledStyleDefinition"/> to a <see cref="Rect"/>.</para>
		/// </summary>
		/// <param name="rect">A source <see cref="Rect"/> to apply position modifications to.</param>
		/// <param name="display">A Boolean value indicating whether the <see cref="Rect"/> should be displayed.</param>
		/// <returns>
		/// <para>A <see cref="Rect"/> that has been modified by this <see cref="CompiledStyleDefinition"/>.</para>
		/// </returns>
		public Rect Filter(Rect rect, out bool display)
		{
