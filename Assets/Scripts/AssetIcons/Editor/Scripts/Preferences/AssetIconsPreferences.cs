...
namespace AssetIcons.Editors.Preferences
{
	...
	public static class AssetIconsPreferences
	{
		...
		private static PreferencesPreset currentPreferences;
		...
		/// </code>
		/// </example>
		public static PreferencesPreset CurrentPreferences
		{
			get
			{
				if (currentPreferences == null)
				{
					...
					{
						currentPreferences = ScriptableObject.CreateInstance<PreferencesPreset>();
					}
					else
					{
						currentPreferences = ScriptableObject.CreateInstance<PreferencesPreset>();
