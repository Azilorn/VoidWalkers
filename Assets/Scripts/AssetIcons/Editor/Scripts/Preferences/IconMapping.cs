...
{
	/// <summary>
	/// <para>Provides a serializable dictionary for mapping an extension type to an <see cref="AssetReference"/>.</para>
	/// </summary>
	/// <seealso cref="PreferencesPreset"/>
	/// <seealso cref="AssetReference"/>
	[Serializable]
	public sealed class IconMapping : ISerializationCallbackReceiver
	{
		...
		private struct TableEntry
		{
			...
			public TableEntry(string key, AssetReference value)
			{
				this.key = key;
				this.value = value;
			}
...
#pragma warning restore RECS0092 // Convert field to readonly
		...
		private readonly Dictionary<string, AssetReference> dictionary = new Dictionary<string, AssetReference>();
