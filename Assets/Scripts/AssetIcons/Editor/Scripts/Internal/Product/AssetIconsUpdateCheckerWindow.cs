	...
	internal class AssetIconsUpdateCheckerWindow : EditorWindow
	{
		...
		public static void Open()
		{
			...
			window.titleContent = new GUIContent("AssetIcons",
				AssetIconResources.CurrentTheme.UpdaterIcon);
		}
		...
		private static void DrawHistory(ProductStatusModel statusModel)
		{
			...
			for (int i = statusModel.VersionHistory.Length - 1; i >= 0; i--)
			{
				...
				if (i != statusModel.VersionHistory.Length - 1)
				{
					...
					{
						GUI.color = originalColor * AssetIconResources.CurrentTheme.FutureVersionLineColor;
					}
					else
					{
						GUI.color = originalColor * AssetIconResources.CurrentTheme.NormalVersionLineColor;
					}
				...
				if (currentIsFutureVersion)
				{
					...
					GUI.color = originalColor * AssetIconResources.CurrentTheme.NormalVersionColor;
				}
				else
				{
					GUI.color = originalColor * AssetIconResources.CurrentTheme.FutureVersionColor;
				}
				...
				GUI.DrawTexture(iconRect, AssetIconResources.CurrentTheme.CircleTexture);
				...
				if (rect.Contains(Event.current.mousePosition))
				{
					...
					if (currentIsCurrentVersion)
					{
						GUI.color = originalColor * AssetIconResources.CurrentTheme.CurrentVersionBackgroundHoverColor;
					}
					else if (currentIsFutureVersion)
					{
						GUI.color = originalColor * AssetIconResources.CurrentTheme.NormalVersionBackgroundHoverColor;
					}
					else
					{
						GUI.color = originalColor * AssetIconResources.CurrentTheme.FutureVersionBackgroundHoverColor;
					}
				}
				else
				{
					if (currentIsCurrentVersion)
					{
						GUI.color = originalColor * AssetIconResources.CurrentTheme.CurrentVersionBackgroundColor;
					}
					else if (currentIsFutureVersion)
					{
						GUI.color = originalColor * AssetIconResources.CurrentTheme.NormalVersionBackgroundColor;
					}
					else
					{
						GUI.color = originalColor * AssetIconResources.CurrentTheme.FutureVersionBackgroundColor;
					}
				}
